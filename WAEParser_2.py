...
Else P[0] = [{ 'id' : p[2], 'value': p[3] },P[5]]
def p_alist_1(p): 'alist : LBRACE ID wae RBRACE
p[0] = { 'id': p[2], 'num': p[3] }
def p_alist_2(p):'alist : LBRACE ID wae RBRACE alist' if p[5]['id'] == p[2]:
p[0] = False
Else P[0] = [{ 'id' : p[2], 'num' : p[3] }, p[5]]
